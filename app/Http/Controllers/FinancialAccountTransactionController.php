...
use App\Models\Study\FinancialAccountTransaction;
use App\Http\Controllers\Controller;
use App\Http\Resources\Study\FinancialAccountTransaction as FinancialAccountTransactionOneCollection;
use App\Http\Resources\Study\FinancialAccountTransactionCollection;
...
class FinancialAccountTransactionController extends Controller
{
    ...
    {
      try {
        $query = FinancialAccountTransaction::find($id);
        return new FinancialAccountTransactionCollection($query);
      } catch (Exception $th) {
        return response()->json([
          'success' => false,
