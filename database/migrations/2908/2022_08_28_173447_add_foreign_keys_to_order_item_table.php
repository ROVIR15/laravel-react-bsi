...
class AddForeignKeysToOrderItemTable extends Migration {
	...
	public function up()
	{
		Schema::table('order_item', function(Blueprint $table)
		{
			...
			$table->foreign('product_feature_id', 'fk_order_item_product_feature_id1')->references('id')->on('product_feature')->onUpdate('CASCADE')->onDelete('SET NULL');
		});
	}
	...
	public function down()
	{
		Schema::table('order_item', function(Blueprint $table)
		{
			...
			$table->dropForeign('fk_order_item_product_feature_id1');
		});
	}
