...
class AddForeignKeysToBomComponentTable extends Migration {
	...
	public function up()
	{
		Schema::table('bom_component', function(Blueprint $table)
		{
			...
			$table->foreign('product_feature_id', 'fk_bom_component_product_feature1')->references('id')->on('product_feature')->onUpdate('CASCADE')->onDelete('CASCADE');
		});
	}
	...
	public function down()
	{
		Schema::table('bom_component', function(Blueprint $table)
		{
			...
			$table->dropForeign('fk_bom_component_product_feature1');
		});
	}
