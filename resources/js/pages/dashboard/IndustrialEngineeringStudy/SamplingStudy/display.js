...
function DisplaySamplingStudy({ placeHolder }) {
  ...
  const handleDeleteData = (event, id) => {
    ...
    alert(id);
    API.deleteSamplingStudy(id, function(res){
                ...
                .map((row) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{work_center.name}</TableCell>
...
export default DisplaySamplingStudy;