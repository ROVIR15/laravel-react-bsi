...
export default function ValidateRowModelControlGrid({ columns, updateItemDisable=false, addItemDisable=false, rows, handleUpdateAllRows, handleAddRow, ...rest }) {
  ...
  return (
    ...
    >
      <Stack
        ...
        columnGap={1}
      >
        <Button size="small" disabled={updateItemDisable} onClick={handleUpdateAllRows}>
          Update
        </Button>
        <Button size="small" disabled={addItemDisable} onClick={handleAddRow}>
          Add Data
        </Button>
      </Stack>
