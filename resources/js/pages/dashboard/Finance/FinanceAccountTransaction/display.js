...
const TABLE_HEAD = [
  ...
  { id: 'type', label: 'Tipe Rekening', alignRight: false },
  { id: 'account_name', label: 'Nama Rekening', alignRight: false },
  { id: 'account_number', label: 'Nomor Rekening', alignRight: false }
];
...
function FinanceAccountTransactionDisplay({ placeHolder }) {
  ...
  const handleDeleteData = (event, id) => {
    ...
    try {
      API.deleteFinanceAccount(id, function(res){
...
export default FinanceAccountTransactionDisplay;