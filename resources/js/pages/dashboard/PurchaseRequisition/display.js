...
const TABLE_HEAD = [
  ...
  { id: 'created_at', label: 'PO Date', alignRight: false },
  { id: 'updated_at', label: 'Valid to', alignRight: false }
];
...
function DisplayPurchaseReq({ placeHolder }) {
...
export default DisplayPurchaseReq;