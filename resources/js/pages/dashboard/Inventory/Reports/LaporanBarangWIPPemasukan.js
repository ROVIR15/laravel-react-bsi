...
function Inbound() {
  ...
  const handleDownload = React.useCallback(() => {
    ...
    // Specify file name
    const filename =
      'Laporan Pemasukan Barang Dalam Proses Dalam Rangka Kegiatan Subkontrak PT Buana Sandang Indonesia.xls';
          ...
          <Grid item>
            <Stack direction="row" justifyContent="space-between" sx={{ marginX: '1em' }}>
              <Typography variant="h5">
                {titleCase(
                  'Laporan Pemasukan Barang Dalam Proses Dalam Rangka Kegiatan Subkontrak '
                )}
              </Typography>
              <Button
                variant="contained"
