                  ...
                  <div className="wk_table_responsive">
                    <table style={{ fontSize: '11px' }}>
                      ...
                      <tr>
                        ...
                        <td className="wk_width_1 wk_padd_8_20 wk_text_left">
                          <a
                            href={`../purchasing/purchase-order/document/${payload?.purchase_order_id}`}
                            target="_blank"
                          >
                      ...
                      <tr>
                        ...
                        <td className="wk_width_1 wk_padd_8_20 wk_text_left">
                          <a href={payload?.vb_attachment} disabled={payload?.vb_attachment ? false : true} target="_blank">{payload?.vb_attachment ? payload?.vb_attachment : 'Belum di Upload'}</a>
                        </td>
                      </tr>
                    </table>
                  </div>
